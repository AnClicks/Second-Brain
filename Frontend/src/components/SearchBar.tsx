        ...
        <>
            <form >
                ...
                <div className="relative">
                    ...
                    <input type="search" id="search" className={`w-102  ${modalStatus? 'border-none':'border-2 border-blue-200'} focus:outline-none focus:ring-2 focus:ring-blue-400 block  p-2 ps-9  text-sm rounded-xl `}placeholder="Search" required />
                </div>
            </form>
